<html lang="en">
    ...
    <body>
        <div class="container mt-5">
            ...
            <h2 class="mb-5 text-center">Edit Tenant</h2>
            <form action="{{route('update-tenant', $tenant->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="username" value="{{ old('username', $tenant->username) }}" required>
                </div>
                <div class="form-group">
                    <label for="name">Password Tenant</label>
                    <input type="text" class="form-control" name="password" value="{{ old('password', $tenant->password) }}" required>
                </div>
